...
/* flag */
enum{
	NS_FLAG_QR=__cpu_to_be16(0x8000),
	NS_FLAG_OPC=__cpu_to_be16(0x7800),
	NS_FLAG_AA=__cpu_to_be16(0x0400),
	NS_FLAG_TC=__cpu_to_be16(0x0200),
	NS_FLAG_RD=__cpu_to_be16(0x0100),
	NS_FLAG_RA=__cpu_to_be16(0x0080),
	NS_FLAG_ZPAD=__cpu_to_be16(0x0070),
	NS_FLAG_RCODE=__cpu_to_be16(0x000f)
};

/* type */

enum{
	NS_TYPE_A=__cpu_to_be16(1),
...
enum{
	NS_CLASS_IN=__cpu_to_be16(1),
	NS_CLASS_ANY=__cpu_to_be16(255)
};
...
size_t static dns_q_set(struct dnshdr_s *dnshdr, char *dname)
{
